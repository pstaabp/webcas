import { Constant, RealConstant, Integer, Real, Complex, Rational, NamedConstant } from './all_constants';
...
export class Parser {
	...
	static parseNamedConstant(str: string): NamedConstant {
		if (str === 'pi') return new NamedConstant('pi');
		else if (str === 'e') return new NamedConstant('e');
		else throw new Error(`The constant ${str} is not defined.`);
	}
}
